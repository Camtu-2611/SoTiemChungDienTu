using SoTiemChungDienTu.Common.Resources;
using System;
...
namespace MISA.CukCuk.Common
{
    ...
    public class ServiceResult
    {
        ...
        {
            result.UserMsg = Messages.Exception_User;
            result.DevMsg = Messages.Exception_User;
        ...
        public void OnBadRequest(ServiceResult result)
        {
            ...
            result.DevMsg = Messages.BadRequest;
            result.UserMsg = Messages.BadRequest;
        }

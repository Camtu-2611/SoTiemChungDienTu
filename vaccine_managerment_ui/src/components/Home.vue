<template>
   <div>
        <div class="page-hero bg-image overlay-dark" style="background-image: url(/public/assets/img/bg_image_1.jpg);">
    <div class="hero-section">
      <div class="container text-center wow zoomIn">
        <h1 class="display-4">Tiêm vắc xin</h1>
        ...
        <div class="row align-items-center">
          ...
          <div class="col-lg-6 wow fadeInRight" data-wow-delay="400ms">
            <div class="img-place custom-img-1">
              <img src="/public/assets/img/bg-doctor.png" alt="">
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="owl-carousel wow fadeInUp" id="doctorSlideshow">
        <div class="item">
          <div class="card-doctor">
            <div class="header">
              <img src="/public/assets/img/doctors/doctor_1.jpg" alt="">
              <div class="meta">
        ...
        <div class="item">
          <div class="card-doctor">
            <div class="header">
              <img src="/public/assets/img/doctors/doctor_2.jpg" alt="">
              <div class="meta">
                <a href="#"><span class="mai-call"></span></a>
                <a href="#"><span class="mai-logo-whatsapp"></span></a>
              </div>
        ...
        <div class="item">
          <div class="card-doctor">
            <div class="header">
              <img src="/public/assets/img/doctors/doctor_3.jpg" alt="">
              <div class="meta">
                <a href="#"><span class="mai-call"></span></a>
                <a href="#"><span class="mai-logo-whatsapp"></span></a>
              </div>
          ...
          <div class="card-blog">
            <div class="header">
              ...
              <a href="blog-details.html" class="post-thumb">
                <img src="/public/assets/img/blog/blog_1.jpg" alt="">
              </a>
            </div>
            <div class="body">
              ...
              <div class="site-info">
                <div class="avatar mr-2">
                  <div class="avatar-img">
                    <img src="/public/assets/img/person/person_1.jpg" alt="">
                  </div>
        ...
        <div class="col-lg-4 py-2 wow zoomIn">
          <div class="card-blog">
            <div class="header">
              ...
              <a href="blog-details.html" class="post-thumb">
                <img src="/public/assets/img/blog/blog_2.jpg" alt="">
              </a>
            </div>
            <div class="body">
        ...
        <div class="col-lg-4 py-2 wow zoomIn">
          <div class="card-blog">
            <div class="header">
              ...
              <a href="blog-details.html" class="post-thumb">
                <img src="/public/assets/img/blog/blog_3.jpg" alt="">
              </a>
            </div>
            <div class="body">
              ...
              <div class="site-info">
                <div class="avatar mr-2">
                  <div class="avatar-img">
                    <img src="/public/assets/img/person/person_2.jpg" alt="">
                  </div>
  ...
  <div class="page-section">
    <div class="container">
      <h1 class="text-center wow fadeInUp">Tư vấn ngay</h1>
      ...
      <form class="main-form">
        <div class="row mt-5 ">
          ...
          <div class="col-12 col-sm-6 py-2 wow fadeInRight" data-wow-delay="300ms">
            <select name="departement" id="departement" class="custom-select">
              ...
              <option value="cardiology">Tiêm chủng cho trẻ em</option>
              <option value="dental">Tiêm chủng cho người lớn</option>
        ...
        <button type="submit" class="btn btn-primary mt-3 wow zoomIn">Gửi ngay</button>
      </form>
    </div>
  </div> <!-- .page-section -->
      ...
      <div class="row align-items-center">
        <div class="col-lg-4 wow zoomIn">
          <div class="img-banner d-none d-lg-block">
            <img src="/public/assets/img/mobile_app.png" alt="">
          </div>
        </div>
        <div class="col-lg-8 wow fadeInRight">
          <h1 class="font-weight-normal mb-3">Get easy access of all features using One Health Application</h1>
          <a href="#"><img src="/public/assets/img/google_play.svg" alt=""></a>
          <a href="#" class="ml-2"><img src="/public/assets/img/app_store.svg" alt=""></a>
        </div>
      </div>
    </div>
  </div> <!-- .banner-home -->

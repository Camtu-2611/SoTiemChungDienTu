  ...
  <div class="component-wrapper">
    <div class="header">
      <div class="align-left">
        <h2 class="tilte">Tính khấu hao tài sản</h2>
      </div>
      <div class="align-right">
          <button class="btn btn-add" @click="AddModal()">Thêm</button>
      </div>
    </div>
    <div class="content">
        ...
        <div class="table-content" style="padding:20px 20px 0;">
          <table>
            ...
            <tr style="text-align:center;">
                ...
                <td>Khấu hao TSCĐ tháng 7 năm 2021</td>
                <td>50.000</td>
                <td>Phượng</td>

  ...
  <div class="content-body">
    ...
    <div class="content-body-main">
      <div class="layout-title">
        <div class="title-top">
          <div class="title-name">Sổ kiểm kê tài sản</div>
      ...
      <div class="overview" v-show="isOverView">
        <div class="inner-overview">
          <div class="overview-item overview-left overview-action">
            ...
            <div class="label-overview">Lọc dữ liệu</div>
          </div>
          <div class="overview-item overview-center overview-action">
            <div class="overview-item-icon"></div>
            <div class="overview-data-number">0,0</div>
            <div class="label-overview">Sắp xếp dữ liệu</div>
          </div>
          <div class="overview-item overview-right">
            <div class="overview-data-number">0,0</div>
            <div class="label-overview">Tính năng nâng cao</div>
          </div>
        </div>
      </div>
      <div class="grid-tool">
      ...
      <div class="grid-main">
        <div class="grid-header">
          ...
          <div class="col-1 col-head">Mã kiểm kê</div>
          <div class="col-2 col-head">Thời gian kiểm kê</div>
          <div class="col-3 col-head">Kiểm kê đến ngày</div>
          <div class="col-4 col-head">Mục đích</div>
          <div class="col-5 col-head">Kết luận</div>
        ...
        <div class="grid-body">
          <div
            ...
            :key="index"
            @dblclick="updateRecord(record.idkiemke)"
          >
            ...
            <div class="col-2 col-body">
              {{ formatDate(record.thoigiankiemke) }}
            </div>
            <div class="col-3 col-body">
              {{ formatDate(record.kiemkedenngay) }}
            </div>
            ...
            <div class="col-record-option col-body col-center">
              <div class="row-option">
                <div
                  ...
                  @click="updateRecord(record.idkiemke)"
                >
                  Sửa
                </div>
                <div
...
export default {
  ...
  methods: {
     ...
     * */
    btnAddOnClick() {
      this.$router.push("/asset/audit-detail/create/new");
    },
     ...
     * */
    updateRecord(id) {
      this.$router.push("/asset/audit-detail/view/" + id);
    },
    ...
    async deleteRecord(id) {
      try {
        await axios
          .delete("https://localhost:44327/api/KiemKe/" + id)
          .then(() => {
          })
          .catch(() => {
            console.error();
    ...
    async processActionYes() {
      await this.deleteRecord(this.recordSelected.idkiemke);
      this.reloadData();
    },
    /**
    ...
    processAction(indexAction) {
      ...
      if (indexAction == 0) {
        this.$refs.recordDetail.showFormReadOnly(
          this.recordSelected.idkiemke
        );
      }
      // chế độ sửa bản ghi
      if (indexAction == 1) {
        this.$refs.recordDetail.showFormUpdate(this.recordSelected.idkiemke);
      }
      // chế độ xóa
      if (indexAction == 2) {
        this.$refs.baseConfirm.showForm(
          "warning",
          2,
          "Bạn có thực sự muốn xóa Bản kiểm kê <" +
            this.recordSelected.makiemke +
            "> không?"
        );
      }
    },
    ...
    async getLimitRecord(pageSize, pageIndex) {
      try {
        ...
        await axios
          .get(
            "https://localhost:44327/api/KiemKe/GetLimitRecord?pageSize=" +
              pageSize +
              "&pageIndex=" +
              pageIndex
          )
    ...
    searchRecord(input) {
      try {
        ...
        this.timeOut = setTimeout(async function () {
          ...
          await axios
            .get(
              "https://localhost:44327/api/KiemKe/SearchLimitRecord?keyWord=" +
                input.trim() +
                "&pageSize=" +
                me.pageSizeCurrent +
                "&pageIndex=" +

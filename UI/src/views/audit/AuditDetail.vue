    ...
    <div class="container">
      <div class="header-layout">
        <div class="top-header">
          ...
          <div class="title-name">Phiếu kiểm kê {{ newCode }}</div>
          <div class="header-combobox">
            <ComboboxPlus
              :inputLabel="{ label: '', require: '' }"
              :comboboxValue="valueTypeForm"
              :inputValue="'1. Nhập thông tin kiểm kê'"
              :disabled="stateReadonly"
              :isEnable="stateCombobox"
            />
          </div>
          <div class="header-button">
            ...
            <div class="button-header">
              <div class="buttons btn-setting"></div>
            </div>
            <div class="button-header">
              <div class="buttons btn-help"></div>
            </div>
            <div class="button-header">
      ...
      <div class="body-layout display-flex-column">
            ...
            <div class="position-relative">
              <div class="width-3-4 position-left">
                <div class="position-relative">
                    ...
                    <div class="display-flex-column">
                      <!-- <div class="row">
                        <div class="width-3-7">
                          <ComboboxPlus
                            ref="inputObject"
                            :inputLabel="{ label: 'Đối tượng', require: '' }"
                            :comboboxValue="valueObject"
                            :inputValue="record.object"
                            v-model="record.object"
                            @rowClicked="rowObjectSelected"
                            :disabled="stateReadonly"
                            :isEnable="stateCombobox"
                          />
                        </div>
                        <div
                          class="width-4-7"
                          style="padding-left: 12px; box-sizing: border-box"
                        >
                          <InputText
                            :inputLabel="{ label: 'Người nhận', require: '' }"
                            :inputValue="record.receiver"
                      ...
                      <div class="row">
                        <InputText
                          :inputLabel="{ label: 'Mục đích', require: '' }"
                          :inputValue="record.mucdich"
                          v-model="record.mucdich"
                          :disabled="stateReadonly"
                        />
                      </div>
                      <div class="row">
                        <InputText
                          :inputLabel="{
                            label: 'Nội dung kết luận',
                            require: '',
                          }"
                          :inputValue="record.ketluan"
                          v-model="record.ketluan"
                          :disabled="stateReadonly"
                      ...
                      <!-- <div class="row">
                        <div class="width-3-7" style="padding-right: 14px">
                          <ComboboxPlus
                            :inputLabel="{ label: 'Nhân viên', require: '' }"
                            :comboboxValue="valueEmployee"
                            :inputValue="record.employeecode"
                            v-model="record.employeecode"
                            :disabled="stateReadonly"
                            :isEnable="stateCombobox"
                          />
                        </div>
                          ...
                          <div class="w-240">
                            <div class="width-4-7">
                              <InputText
                                type="number"
                                pattern="(d{3})([.])(d{2})"
                                :inputLabel="{ label: 'Kèm theo', require: '' }"
                                :cursorInput="'end'"
                                placeholder="Số lượng"
                                :inputValue="record.attach"
                                v-model="record.attach"
                                :disabled="stateReadonly"
                              />
                            </div>
                            <div class="widht-3-7" style="padding: 28px 6.5px 0px">
                              chứng từ gốc
                            </div>
                          </div>
                        </div>
                      ...
                      <div class="row">
                        <div class="row-checkbox">
                          <div
                            class="row-checkbox-main"
                            style="margin-top: 16px"
                          >
                            <div class="input-checkbox">
                              <input
                                type="checkbox"
                                v-model="record.foreignCurrencyAccounting"
                              />
                              <div class="label-checkbox">
                                Đã xử lý kiến nghị
                              </div>
                            </div>
                          </div>
                        </div>
                  ...
                  <div class="width-1-5 positon-right display-flex-column">
                    <div class="row-input-right">
                      <InputDate
                        :inputLabel="{ label: 'Ngày kiểm kê', require: '' }"
                        :inputValue="accountingDate"
                    ...
                    <div class="row-input-right">
                      <InputDate
                        :inputLabel="{ label: 'Kiểm kê đến ngày', require: '' }"
                    ...
                    <div class="row-input-right" style="padding-bottom: 0px">
                      <InputText
                        :inputLabel="{ label: 'Số phiếu kiểm kê', require: '' }"
                        :inputValue="record.makiemke"
                        v-model="record.makiemke"
                        ref="inputLicenseNumber"
                        :disabled="stateReadonly"
                        @blur="
                          tabValidate(
                            'inputLicenseNumber',
                            'Số phiếu kiểm kê không được để trống.'
                          )
                        "
                      />
                    </div>
        ...
        <!-- Phần thành viên tham gia -->

        <div class="grid">
          <div class="grid-tool">
            <div class="tab-label">Thành viên tham gia</div>
            <div class="grid-option">
              <div class="grid-option-item"></div>
              <div class="grid-option-item" v-if="typeMoney != 'VND'">
                <div class="label-option">Tỷ giá</div>
                <div class="number-group">
                  <InputText
                    :inputLabel="{ label: '', require: '' }"
                    :paddingLabel="'0px'"
                    :inputValue="record.exchangeRate"
                    v-model="record.exchangeRate"
                    :disabled="stateReadonly"
                    :cursorInput="'end'"
                    type="number"
                    @change="calculatorTotalMoney"
                  />
                </div>
              </div>
            </div>
        ...
        <div class="grid-content">
          <div class="grid-header">
            ...
            <div class="col-1 col-header col-center">#</div>
            <div class="col-2-1 col-header">Họ và tên</div>
            <div class="col-3-1 col-header">Chức danh</div>
            <div class="col-4-1 col-header">Đại diện</div>
            <div
              class="col-9 col-header"
          ...
          <div class="grid-body">
            <div
              class="grid-row"
              v-for="(row, index) in thanhviens"
              :key="index"
              @click="rowThanhVienOnClick(index)"
            >
              <div class="col-blank-left"></div>
              <div
                class="col-1 col-body-1 col-center col-input"
                v-if="!row.isText"
              >
                {{ index + 1 }}
              </div>
              <div class="col-1 col-body-2 col-center" v-if="row.isText">
                {{ index + 1 }}
              </div>
              <div class="col-2-1 col-body-1 col-input" v-if="!row.isText">
                <InputText
                  :inputLabel="{ label: '', require: '' }"
                  :paddingLabel="'0px'"
                  :inputValue="row.data.ten"
                  v-model="row.data.ten"
                  :disabled="stateReadonly"
                  @change="updateIsChangeExplain"
                  :ref="'inputExplain_' + index"
                />
              </div>
              <div
                class="col-2-1 col-body-2"
                v-if="row.isText"
                @click="setFocusDynamicRef('inputExplain_' + index)"
              >
                {{ row.data.ten }}
              </div>
              <div class="col-3-1 col-body-1 col-input" v-if="!row.isText">
                <InputText
                  :inputLabel="{ label: '', require: '' }"
                  :paddingLabel="'0px'"
                  :inputValue="row.data.chucdanh"
                  v-model="row.data.chucdanh"
                  :disabled="stateReadonly"
                  @change="updateIsChangeExplain"
                  :ref="'inputExplain_' + index"
                />
              ...
              <div
                class="col-3-1 col-body-2"
                v-if="row.isText"
                @click="setFocusDynamicRef('inputExplain_' + index)"
              >
                {{ row.data.chucdanh }}
              </div>
              <div class="col-4-1 col-body-1 col-input" v-if="!row.isText">
                <InputText
                  :inputLabel="{ label: '', require: '' }"
                  :paddingLabel="'0px'"
                  :inputValue="row.data.daidien"
                  v-model="row.data.daidien"
                  :disabled="stateReadonly"
                  @change="updateIsChangeExplain"
                  :ref="'inputExplain_' + index"
                />
              ...
              <div
                class="col-9 col-body-1 col-center col-input"
                style="border-left: 1px solid #c7c7c7"
                v-if="!row.isText"
              >
                <div
                  class="icon-delete"
                  v-if="!stateReadonly"
                  @click="btnDeleteRowThanhVienTable(index)"
                ></div>
                <div class="icon-delete" v-if="stateReadonly"></div>
              </div>
              <div
                class="col-9 col-body-2 col-center"
                style="border-left: 1px solid #c7c7c7"
                v-if="row.isText"
              >
                <div
        ...
        <div class="grid-control" style="padding: 0px 26px">
          <div class="width-3-4">
            <div class="btn-grid" style="padding: 16px 0px 0px">
              <div
                class="btn-item"
                v-if="!stateReadonly"
                @click="btnAddRowTable2()"
              >
                Thêm dòng
              </div>
              <div class="btn-disable" v-if="stateReadonly">Thêm dòng</div>
              <div
                class="btn-item"
                @click="btnDeleteAllRowThanhVienOnClick()"
                v-if="!stateReadonly"
              >
                Xóa hết dòng
              </div>
              <div class="btn-disable" v-if="stateReadonly">Xóa hết dòng</div>
            </div>
          </div>
        </div>
        <!-- Kết thúc phần thành viên tham gia  -->

        <!-- Phần chi tiết kiểm kê -->
        <div class="grid">
          <div class="grid-tool">
            <div class="tab-label">Chi tiết kiểm kê</div>
            <div class="grid-option">
              <div class="grid-option-item">
                <!-- <div class="label-option">Loại tiền</div>
                <div class="combobox-option">
                  <ComboboxPlus
                    :inputLabel="{ label: '', require: '' }"
                    :comboboxValue="valueTypeMoney"
                    :inputValue="typeMoney"
                    v-model="typeMoney"
                    @rowClicked="rowTypeMoneyClicked"
                    :disabled="stateReadonly"
                    :isEnable="stateCombobox"
                  />
                </div> -->
        ...
        <div class="grid-content">
          <div class="grid-header">
            <div class="col-blank-left"></div>
            <div class="col-1 col-header col-center">#</div>
            <div class="col-2 col-header">Mã tài sản</div>
            <div class="col-3 col-header">Tên tài sản</div>
            <div class="col-4 col-header">Đơn vị sử dụng</div>
            <div class="col-5 col-header col-right">Nguyên giá</div>
            <div class="col-6 col-header" v-if="typeMoney != 'VND'">
              Quy đổi
            </div>
            <div class="col-7 col-header col-right">Giá trị tính khấu hao</div>
            <div class="col-8 col-header">Hao mòn lũy kế</div>
            <div class="col-8 col-header">Giá trị còn lại</div>
            <div class="col-8 col-header">Tồn tại</div>
            <div class="col-8 col-header">Chất lượng hiện thời</div>
            <div class="col-8 col-header">Ghi chú</div>
            <div
              class="col-9 col-header"
              style="border-left: 1px solid #c7c7c7"
            ></div>
          ...
          <div class="grid-body">
            <div
              class="grid-row"
              v-for="(row, index) in rowKiemKes"
              :key="index"
              @click="rowTableOnClick(index)"
            >
              <div class="col-blank-left"></div>
              <div
                class="col-1 col-body-1 col-center col-input"
              ...
              <!-- mã tài sản  -->
              <div class="col-2 col-body-1">
                {{ row.data.mataisan }}
              </div>

              <!-- tên tài sản  -->
              <div class="col-3 col-body-2">
                {{ row.data.tentaisan }}
              </div>

              <!-- bộ phận sử dụng -->
              <div class="col-4 col-body-2">
                {{ row.data.bophansudung }}
              </div>

              <!-- nguyên giá -->
              <!-- <div
                class="col-5 col-body-1 col-right col-input"
                v-if="!row.isText"
              >
                <InputText
                  type="number"
                  ...
                  :paddingLabel="'0px'"
                  :cursorInput="'end'"
                  :inputValue="row.data.nguyengia"
                  v-model="row.data.nguyengia"
                  :disabled="stateReadonly"
                  @keyup="setChangeExChangeMoney(index)"
                  @change="calculatorTotalMoney()"
                  :ref="'inputnguyengia' + index"
                />
              </div> -->
              <div
                class="col-5 col-body-2 col-right"
                @click="setFocusDynamicRef('inputnguyengia' + index)"
              >
                {{ formatMoney(row.data.nguyengia) }}
              </div>

              <!-- giá trị tính khấu hao -->
              <!-- <div
                class="col-6 col-body-1 col-input"
                v-if="!row.isText"
              >
                 <InputText
                  type="number"
                  ...
                  :paddingLabel="'0px'"
                  :cursorInput="'end'"
                  :inputValue="row.data.giatritinhkhauhao"
                  v-model="row.data.giatritinhkhauhao"
                  :disabled="stateReadonly"
                  @keyup="setChangeExChangeMoney(index)"
                  @change="calculatorTotalMoney()"
                  :ref="'inputGTtinhkhauhao' + index"
                />
              </div> -->
              <div
                class="col-6 col-body-2 col-right"
                @click="setFocusDynamicRef('inputGTtinhkhauhao' + index)"
              >
                {{ formatMoney(row.data.giatritinhkhauhao) }}
              </div>

              <!-- hao mòn lũy kế -->
              <!-- <div class="col-7 col-body-1 col-input col-right" v-if="!row.isText">
                <InputText
                  type="number"
                  :inputLabel="{ label: '', require: '' }"
                  :paddingLabel="'0px'"
                  :cursorInput="'end'"
                  :inputValue="row.data.haomonluyke"
                  v-model="row.data.haomonluyke"
                  :disabled="stateReadonly"
                  @keyup="setChangeExChangeMoney(index)"
                  @change="calculatorTotalMoney()"
                  :ref="'inputHMLuyKe' + index"
                />
              </div> -->
              <div
                class="col-7 col-body-2 col-right"
                @click="setFocusDynamicRef('inputHMLuyKe' + index)"
              >
                {{ formatMoney(row.data.haomonluyke) }}
              </div>
              ...
              >
                <InputText
                  ...
                  :paddingLabel="'0px'"
                  :cursorInput="'end'"
                  :inputValue="row.data.giatriconlai"
                  v-model="row.data.giatriconlai"
                  :disabled="stateReadonly"
                  @keyup="setChangeExChangeMoney(index)"
                  @change="calculatorTotalMoney()"
                  :ref="'inputGTConlai' + index"
                />
              </div> -->
              <div
                class="col-5 col-body-2 col-right"
                @click="setFocusDynamicRef('inputGTConlai' + index)"
              >
                {{ formatMoney(row.data.giatriconlai) }}
              </div>
              ...
              >
                <InputText
                  ...
                  :paddingLabel="'0px'"
                  :cursorInput="'end'"
                  :inputValue="row.data.tontai"
                  v-model="row.data.tontai"
                  :disabled="stateReadonly"
                  @keyup="setChangeExChangeMoney(index)"
                  @change="calculatorTotalMoney()"
                  :ref="'inputTonTai' + index"
                />
              </div>
              <div
                class="col-5 col-body-2 col-right"
                v-if="row.isText"
                @click="setFocusDynamicRef('inputTonTai' + index)"
              >
                {{ row.data.tontai }}
              </div>

              <!-- chất lượng hiện thời -->
              <div
                class="col-5 col-body-1 col-right col-input"
                v-if="!row.isText"
              >
                <InputText
                  ...
                  :paddingLabel="'0px'"
                  :cursorInput="'end'"
                  :inputValue="row.data.chatluonghienthoi"
                  v-model="row.data.chatluonghienthoi"
                  :disabled="stateReadonly"
                  @keyup="setChangeExChangeMoney(index)"
                  @change="calculatorTotalMoney()"
                  :ref="'inputChatLuong' + index"
                />
              </div>
              <div
                class="col-5 col-body-2 col-right"
                v-if="row.isText"
                @click="setFocusDynamicRef('inputChatLuong' + index)"
              >
                {{ row.data.chatluonghienthoi }}
              </div>
              ...
              >
                <InputText
                  ...
                  :paddingLabel="'0px'"
                  :cursorInput="'end'"
                  :inputValue="row.data.ghichu"
                  v-model="row.data.ghichu"
                  :disabled="stateReadonly"
                  @keyup="setChangeExChangeMoney(index)"
                  @change="calculatorTotalMoney()"
                  :ref="'inputGhiChu' + index"
                />
              </div>
              <div
                class="col-5 col-body-2 col-right"
                v-if="row.isText"
                @click="setFocusDynamicRef('inputGhiChu' + index)"
              >
                {{ row.data.ghichu }}
              </div>
            ...
            <div class="grid-row row-end">
              <div class="col-blank-left"></div>
              <div class="col-1 col-bottom col-center"></div>
              <div class="col-2 col-bottom"></div>
              <div class="col-3 col-bottom"></div>
              <div class="col-4 col-bottom"></div>
              <div class="col-5 col-bottom text-bold col-right">
                <!-- {{ formatMoney(amountOfMoney) }} -->
              </div>
              <div class="col-6 col-bottom col-right" v-if="typeMoney != 'VND'">
                <!-- {{ formatMoney(totalMoney) }} -->
              </div>
              <div class="col-7-name col-bottom"></div>
              <div class="col-8 col-bottom"></div>
            </div>
          </div>
        </div>
        <div class="grid-control">
          <div class="width-3-4">
            ...
            <div class="width-1-2 control-file">
              <div class="title-upload">
                <div class="title-label display-flex-row">
                  <div class="label-icon"></div>
                  <div class="label-text">Đính kèm</div>
                </div>
                <div class="title-detail">Dung lượng tối đa 5MB</div>
              </div>

              <div class="input-upload" v-if="!stateReadonly">
                <input type="file" />
                <div class="file-detail">
                  <div class="file-name" v-show="true">
                    <div class="file-name-text">bienbankiemke.pdf</div>
                    <div class="file-name-size">(25.23kb)</div>
                    <div class="x-file">X</div>
                  </div>
                  <div class="file-detail">
              ...
              <div class="input-upload disable" v-if="stateReadonly">
                <input type="file" disabled />
                <div class="file-detail">
                  <div class="file-name" v-show="true">
                    <div class="file-name-text">ketoan.pdf</div>
                    <div class="file-name-size">(25.23kb)</div>
                    <div class="x-file">X</div>
                  </div>
                  <div class="file-detail">
      ...
      <div class="footer" v-if="stateReadonly">
        <div class="footer-main">
          ...
          <div class="position-right display-flex-row">
            ...
            <div class="btn-simple">
              <div class="button-green">Trở về</div>
            </div>
          </div>
        </div>
      </div>
...
export default {
  ...
  data() {
    return {
      ...
      // làm lại bài quản lý tài sản
  ...
  methods: {
    ...
    async setValueDefaultGrid() {
      // row gird thành viên
      this.thanhviens = [
        {
          data: {
            ten: "",
      ...
      // row grid kiểm kê:
      await this.getAllTaiSan();
      for (let i = 0; i < this.taisans.length; i++) {
        this.rowKiemKes.push({
          data: {
            idtaisan: this.taisans[i].idtaisan,
            mataisan: this.taisans[i].mataisan,
            tentaisan: this.taisans[i].tentaisan,
            bophansudung: this.taisans[i].bophansudung,
            nguyengia: this.taisans[i].nguyengia,
            giatritinhkhauhao: this.taisans[i].giatritinhkhauhao,
            haomonluyke: this.taisans[i].haomonluyke,
            giatriconlai: this.taisans[i].giatriconlai,
            tontai: "Còn",
            chatluonghienthoi: "Hoạt động tốt",
            ghichu: "",
          },
          isText: true,
        });
    ...
    async processActionYes(idAction) {
      ...
      if (idAction == "deleteAllRowThanhVien") {
        this.deleteAllRowThanhVienGrid();
      }
      if (idAction == "autoIncrement") {
        await this.getNewCode();
        this.record.makiemke = this.newCode;
    ...
    rowTableOnClick(index) {
      for (let i = 0; i < this.rowKiemKes.length; i++) {
        this.rowKiemKes[i].isText = true;
        if (i == index) {
          this.rowKiemKes[index].isText = false;
        }
      }
    },

    rowThanhVienOnClick(index) {
      for (let i = 0; i < this.thanhviens.length; i++) {
        this.thanhviens[i].isText = true;
        if (i == index) {
          this.thanhviens[index].isText = false;
        }
      }
    },
    /**
    ...
    btnAddRowTable2() {
      // 1. Đặt chế độ hiển thị text của tất cả các dòng bên trên bằng  true: chỉ hiển thị text, ẩn input
      this.thanhviens.forEach((element) => {
        element.isText = true;
      });

      // 2. Khởi tạo 1 dòng mới, và add vào rowBankAccounts
      this.thanhviens.push({
        data: {
          ten: "",
          chucdanh: "",
          daidien: "",
    ...
    btnDeleteRowTable(index) {
      // this.rowKiemKes.splice(index, 1);
      console.log(index);
      this.calculatorTotalMoney();
    },

    btnDeleteRowThanhVienTable(index) {
    ...
    btnDeleteAllRowThanhVienOnClick() {
      this.$refs.baseConfirm.showForm(
        "warning",
        2,
        "Bạn có thực sự muốn xóa tất cả các dòng đã nhập không?",
        "deleteAllRowThanhVien"
      );
    },
    ...
    async processShowForm() {
      ...
      if (this.stateForm == "view") {
        ...
        await this.getCTById(this.idRecord);
        this.newCode = this.record.makiemke;
        this.thanhviens = this.toListObject(this.record.thanhvienthamgia);
        this.accountingDate = moment(this.record.thoigiankiemke).format("YYYY-MM-DD");
        this.paymentDate = moment(this.record.kiemkedenngay).format(
          "YYYY-MM-DD"
        );
        this.stateReadonly = true;
        this.stateCombobox = "offline";
     ...
     * */
    processToStringJson() {
      this.record.thanhvienthamgia = JSON.stringify(
        this.getDataFromArray(this.thanhviens)
      );

      let ctkk = [];
      this.rowKiemKes.forEach(element => {
        ctkk.push(element.data);
      });
      this.record.chiTietKiemKes = ctkk;
      this.record.thoigiankiemke = this.accountingDate;
      this.record.kiemkedenngay = this.paymentDate;
    },
    ...
    async getRecordById(id) {
      var me = this;
      await axios
        .get("https://localhost:44327/api/KiemKe/" + id)
        .then((response) => {
          me.record = response.data;
...
// lấy ct kk theo id
    async getCTById(id) {
      ...
      let rs = [];
      await axios
        .get("https://localhost:44327/api/KiemKe/GetChiTiet/" + id)
        .then((response) => {
          rs = response.data;
          me.$refs.loading.hideLoading();
        })
      ...
      for (let i = 0; i < rs.length; i++) {
        this.rowKiemKes.push({
          data: {
            idtaisan: rs[i].idtaisan,
            mataisan: rs[i].mataisan,
            tentaisan: rs[i].tentaisan,
            bophansudung: rs[i].bophansudung,
            nguyengia: rs[i].nguyengia,
            giatritinhkhauhao: rs[i].giatritinhkhauhao,
            haomonluyke: rs[i].haomonluyke,
            giatriconlai: rs[i].giatriconlai,
            tontai: rs[i].tontai,
            chatluonghienthoi: rs[i].chatluonghienthoi,
            ghichu: rs[i].ghichu,
          },
          isText: true,
        });
    ...
    async getAllTaiSan() {
      var me = this;
      await axios
        .get("https://localhost:44327/api/TaiSan/GetAll")
        .then((response) => {
          me.taisans = response.data;
        })
        .catch();
    },
    ...
    async checkExistCode(code) {
      try {
        ...
        await axios
          .get(
            "https://localhost:44327/api/KiemKe/CheckDupCode?code=" +
              code
          )
    ...
    insertRecord() {
      try {
        ...
        this.record.kiemkedenngay = this.paymentDate;
        axios
          .post("https://localhost:44327/api/KiemKe", this.record)
          .then(() => {
    ...
    updateRecord() {
      try {
        ...
        axios
          .put(
            "https://localhost:44327/api/KiemKe/" + this.record.idkiemke,
            this.record
          )
          .then(() => {
    ...
    validateInputEmpty() {
      if (
        this.record.makiemke.trim() == "" ||
        this.record.makiemke == null
      ) {
        this.$refs.baseConfirm.showForm(
          "error",
          1,
    ...
    async validateExistCode() {
      await this.checkExistCode(this.record.makiemke);
    ...
    btnEditOnClick() {
      ...
      // this.getByCode(this.record.makiemke);
      this.recordCompare = JSON.stringify(Object.assign({}, this.record));
    },
    /**

  ...
  <div class="content-body">
    ...
    <div class="content-body-main">
      <div class="layout-title">
        <div class="title-top">
          <div class="title-name">Kế hoạch bảo dưỡng</div>
          <div class="title-tool">
            <!-- <div class="title-button">
              <ButtonGuide />
            </div> -->
            <div class="title-button" style="margin-right: 4px;">
              <ButtonSimple
                :buttonName="'Thêm'"
                @buttonSimpleOnClick="btnAddOnClick"
              />
            </div>
            <div class="title-button">
              <ButtonSimple
                :buttonName="'Gửi kế hoạch'"
                @buttonSimpleOnClick="btnSendOnClick"
              />
            </div>
          </div>
        </div>
        <div class="title-bottom">
          ...
          <div class="title-bottom-content"></div>
        </div>
      </div>
      ...
      <div class="grid-main">
        <div class="grid-header">
          ...
          <div class="col-1 col-head">STT</div>
          <div class="col-2 col-head">Mã tài sản</div>
          <div class="col-3 col-head">Tên tài sản</div>
          <div class="col-4 col-head">Loại tài sản</div>
          <div class="col-5 col-head">Bộ phận sử dụng</div>
          <div class="col-6 col-head">Ngày dự kiến</div>
          <div class="col-6 col-head">Dự toán</div>
          <div class="col-6 col-head">Loại bảo dưỡng</div>
          <div class="col-6 col-head">Mô tả</div>
          <!-- <div
...
export default {
  ...
  created() {
    ...
    //   this.records.push({
    //     code: "KIEMKE" + i,
    //     time: "26/10/2020 15:30:00",
    //     inventory_date: "25/10/2021",
    //     purpose: "Mục đích kiểm kê của KIEMKE" + i,
    //     conclusion: "Kết luận kiểm kê của KIEMKE" + i,
    //   });
    // }
  },
  ...
  methods: {
    ...
    getAllRecord() {
      try {
        var me = this;
        axios
          .get("https://localhost:44382/api/v1/kehoachbaoduong")
          .then((response) => {
     ...
     * */
    btnAddOnClick() {
      this.$router.push("/asset/ctbaoduong/create/new");
    },

    ...
    <div class="container">
      <div class="header-layout">
        <div class="top-header">
          ...
          <div class="title-name">Phiếu chuyển sở hữu{{ newCode }}</div>
          <div class="header-combobox">
            <ComboboxPlus
              :inputLabel="{ label: '', require: '' }"
              :comboboxValue="valueTypeForm"
              :inputValue="'1. Nhập thông tin chuyển sỡ hữu'"
      ...
      <div class="body-layout display-flex-column">
                ...
                <div class="position-relative">
                  <div class="width-4-5 positon-left">
                    <div class="display-flex-column">
                      <div class="row">
                        <InputText
                          :inputLabel="{ label: 'Diễn giải', require: '' }"
                          :inputValue="record.address"
                      ...
                      <div class="row">
                        <div class="width-3-7">
                          <ComboboxPlus
                            ref="inputObject"
                            :inputLabel="{ label: 'Mã tài sản', require: '' }"
                        ...
                        >
                          <InputText
                            :inputLabel="{ label: 'Tên tài sản', require: '' }"
                  ...
                  <div class="width-1-5 positon-right display-flex-column">
                    <div class="row-input-right">
                      <InputDate
                        :inputLabel="{ label: 'Ngày thực hiện', require: '' }"
                    ...
                    <div class="row-input-right" style="padding-bottom: 0px">
                      <InputText
                        ...
                        :inputValue="record.licenseNumber"
                        v-model="record.licenseNumber"
        ...
        <div class="grid">
          <div class="grid-tool">
            <div class="tab-label">Tài sản</div>
        ...
        <div class="grid-content">
          <div class="grid-header">
            ...
            <div class="col-2 col-header">Thông tin tài sản</div>
            <div class="col-3 col-header">Giá trị hiện thời</div>
            <div class="col-4 col-header">Giá trị mới</div>
            <div class="col-5 col-header col-right">Chênh lệch</div>
            <div
          ...
          <div class="grid-body">
            ...
            >
              ...
              <div class="col-2 col-body-1 col-input" v-if="!row.isText">
                <InputText
                  :inputLabel="{ label: '', require: '' }"
                  :paddingLabel="'0px'"
                  :inputValue="row.data.explain"
                  v-model="row.data.explain"
                  :disabled="stateReadonly"
              ...
              <div class="col-3 col-body-1 col-input" v-show="!row.isText">
                <ComboboxPlus
                  :inputLabel="{ label: '', require: '' }"
                  :paddingLabel="'0px'"
                  :comboboxValue="valueDebtAccount"
                  :inputValue="row.data.debtAccount"
                  v-model="row.data.debtAccount"
                  :disabled="stateReadonly"
                  :isEnable="stateCombobox"
                  :ref="'inputDebtAccount_' + index"
                  @blur="
                    tabValidateDynamicRef(
                      'inputDebtAccount_' + index,
              ...
              <div
                class="col-3 col-body-2"
                v-show="row.isText"
                @click="setFocusDynamicRef('inputDebtAccount_' + index)"
              >
                {{ row.data.debtAccount }}
              </div>
              <div class="col-4 col-body-1 col-input" v-show="!row.isText">
                <ComboboxPlus
                  :inputLabel="{ label: '', require: '' }"
                  :paddingLabel="'0px'"
                  :comboboxValue="valueDebtAccount"
                  :inputValue="row.data.ownAccount"
                  v-model="row.data.ownAccount"
                  :disabled="stateReadonly"
                  :isEnable="stateCombobox"
                  :ref="'inputOwnAccount_' + index"
                  @blur="
                    tabValidateDynamicRef(
                      'inputOwnAccount_' + index,
              ...
              <div
                class="col-4 col-body-2"
                v-if="row.isText"
                @click="setFocusDynamicRef('inputOwnAccount_' + index)"
              >
                {{ row.data.ownAccount }}
              </div>
              ...
              >
                <InputText
                  ...
                  :paddingLabel="'0px'"
                  :cursorInput="'end'"
                  :inputValue="row.data.amountOfMoney"
                  v-model="row.data.amountOfMoney"
                  :disabled="stateReadonly"
                  @keyup="setChangeExChangeMoney(index)"
                  @change="calculatorTotalMoney()"
                  :ref="'inputAmountOfMoney_' + index"
                />
              </div>
              <div
                class="col-5 col-body-2 col-right"
                v-if="row.isText"
                @click="setFocusDynamicRef('inputAmountOfMoney_' + index)"
              >
                {{ formatMoney(row.data.amountOfMoney) }}
              </div>
